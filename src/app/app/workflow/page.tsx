...
/* ============================================================
   NODE CARD
============================================================ */
function NodeCard({ node, selected, onSelect, onDelete, onDragStart, onPortMouseDown, onPortMouseUp, onAddAfter }) {
  ...
  const bodyRows = useMemo(() => {
    switch (node.type) {
      ...
      case "condition":return [["❓","Check",f.field],["⚖","Op",f.op+" "+f.val]];
...
/* ============================================================
   EDGE SVG
============================================================ */
function Edges({ nodes, edges, connecting }) {
...
/* ============================================================
   PROPERTY PANEL
============================================================ */
function Panel({ node, onUpdate, onDelete }) {
  if (!node) return (
...
/* ============================================================
   CONTEXT MENU
============================================================ */
function ContextMenu({ ctx, onDuplicate, onDelete, onDisable, onAddAfter, onClose }) {
  if (!ctx) return null;
  const items = [
